...
>
>
> ## Feature<OptionalParentFeature> : *optional description of the feature type*
> [ ] Abstract
>
> # INTERNAL_COMPONENTS
> - componentFeature1
...
>
> # INPUTS
> [connectedFeature1, connectedFeature2] -> action(param1, param2, param3) => optionalResponseFeatureA
>
> # OUTPUTS
> action(param1, param2) -> [connectedFeature3] => optionalResponseFeatureB
> 
> # TESTCASES
>
> # REFERENCED_BY
