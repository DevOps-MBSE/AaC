...
The below sections have links to the different profilers that can be used with AaC have some talks regarding the benefits/hinderances of both.

### cProfile Setup and Justification

cProfile Setup and Justification documentation can be located here -> [cProfile Setup](./profiles/cprofile.md)
### Profile Setup and Justification

Python Profile Setup and Justification documentation can be located here -> [Python Profile Setup](./profiles/python_profile.md)
