...
class TestGenerateProtobufPlugin(ActiveContextTestCase):
    ...
    def test_gen_protobuf(self):
        with TemporaryDirectory() as temp_dir, TemporaryAaCTestFile(TEST_ARCH_YAML_STRING) as temp_arch_file:
    ...
    def test__generate_protobuf_details_from_data_message_model(self):
        ...
        test_message_definition = create_schema_definition(name=TEST_MESSAGE_A_NAME, description=TEST_MESSAGE_A_DESCRIPTION, fields=[test_message_field])
