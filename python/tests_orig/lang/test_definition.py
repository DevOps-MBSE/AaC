...
from aac.plugins.validators.required_fields import get_required_fields, VALIDATION_NAME
...
class TestDefinition(TestCase):
    ...
    def test_get_required_with_two_required_entries(self):
        ...
        required_fields_validator = create_validation_entry(VALIDATION_NAME, test_required)
