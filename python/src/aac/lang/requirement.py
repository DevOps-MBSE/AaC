...
class Requirement:
    ...
    childern: list[str] - A list of requirements that are decomposed from this requirement.
    ...
    def from_dict(cls, data):
        ...
        childern = data.pop("childern", [])
        args["childern"] = childern
