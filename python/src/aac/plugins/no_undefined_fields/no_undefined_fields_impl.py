...
def no_extra_fields(
    ...
    defined_fields = [field.name for field in defining_schema.instance.fields]
    if defining_schema.instance.extends:
        for parent in defining_schema.instance.extends:
