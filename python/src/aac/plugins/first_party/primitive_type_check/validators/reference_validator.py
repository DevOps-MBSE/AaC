...
def validate_reference(definition: Definition, value_to_validate: Any) -> Optional[ValidatorFinding]:
    """
    ...
    """
    finding = None
    if not get_active_context().get_definition_by_name(value_to_validate):
        ...
        finding_location = FindingLocation.from_lexeme(REFERENCE_VALIDATION_NAME, lexeme)
