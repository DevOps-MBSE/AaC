"""The AaC Generate Plugin plugin implementation module."""
...
def gen_plugin(
    ...
    messages: list[ExecutionMessage] = []
    error_msg = ExecutionMessage(
        "The gen-plugin command for the Generate Plugin plugin has not been implemented yet.",
        None,
        None,
    )
    messages.append(error_msg)
...
def gen_project(
    ...
    messages: list[ExecutionMessage] = []
    error_msg = ExecutionMessage(
        "The gen-project command for the Generate Plugin plugin has not been implemented yet.",
        None,
        None,
    )
    messages.append(error_msg)
