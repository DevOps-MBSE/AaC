...
def get_plugin_validations_from_definitions(plugin_definitions: list[Definition], callback: Callable) -> list[RuleValidationContribution]:
    """
    ...
    return [RuleValidationContribution(validation_definition.name, validation_definition, callback)]
