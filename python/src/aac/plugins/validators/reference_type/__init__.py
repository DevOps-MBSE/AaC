...
from aac.plugins.validators.reference_type._reference_type import PLUGIN_NAME, validate_reference_types
...
def _get_plugin_definitions():
    return get_plugin_definitions_from_yaml(__package__, "reference_type.yaml")


def _get_plugin_validations():
    return get_plugin_validations_from_definitions(_get_plugin_definitions(), validate_reference_types)
