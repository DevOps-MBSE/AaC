    ...
    def validate_dict(dict_to_validate: dict) -> None:
        for required_field_name in required_field_names:
            ...
            if field_value is None:
                ...
                findings.add_error_finding(target_schema_definition, missing_required_field)
                ...
                findings.add_error_finding(target_schema_definition, unpopulated_required_field)
