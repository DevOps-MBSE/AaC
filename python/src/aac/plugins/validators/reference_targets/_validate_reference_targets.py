...
def validate_reference_targets(
    ...
    *validation_args,
    ...
    def validate_dict(dict_to_validate: dict) -> None:
        for reference_field_name in reference_field_names:
            ...
            if field_type != PRIMITIVE_TYPE_REFERENCE:
                ...
                reference_field_name_lexeme = definition_under_test.get_lexeme_with_value(reference_field_name) ### TODO: POPO update ###
            ...
            # field must not be empty
                ...
                findings.add_error_finding(
                    definition_under_test, missing_reference_field, PLUGIN_NAME, reference_field_name_lexeme    ### TODO: POPO update ###
                )
            ...
            # field must reference an existing target
                ...
                reference_field_name_lexeme = definition_under_test.get_lexeme_with_value(reference_field_name) ### TODO: POPO update ###
                findings.add_error_finding(
                    definition_under_test,  ### TODO: POPO update ###
                    invalid_reference_target,
                    PLUGIN_NAME,
    ...
    return ValidatorResult([definition_under_test], findings)   ### TODO: POPO update ###
