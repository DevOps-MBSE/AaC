...
def to_definition_model(definition: Definition) -> DefinitionModel:
    ...
    return DefinitionModel(
        name=definition.name, content=definition.content, source_uri=definition.source_uri, structure=definition.structure
    )
...
def to_definition_class(definition_model: DefinitionModel) -> Definition:
    ...
    definition = Definition(name=definition_model.name, content="", source_uri="", structure=definition_model.structure)
