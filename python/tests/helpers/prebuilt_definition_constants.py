...
TEST_TYPES_SCHEMA_EXTENSION_FIELD = create_field_entry(TEST_TYPES_ROOT_KEY, PRIMITIVE_TYPE_REFERENCE)
TEST_TYPES_SCHEMA_EXTENSION_DEFINITION = create_schema_ext_definition(TEST_TYPES_SCHEMA_DEFINITION.name, DEFINITION_NAME_ROOT, "")
