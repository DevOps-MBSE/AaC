...
class TestValidatorFindings(TestCase):
    ...
    def test_add_specific_findings(self):
        ...
        validator_findings.add_error_finding(DEFAULT_TEST_DEFINITION, error_message, "validate thing", source_location)
        ...
        validator_findings.add_warning_finding(DEFAULT_TEST_DEFINITION, warning_message, "validate thing", source_location)
        ...
        validator_findings.add_info_finding(DEFAULT_TEST_DEFINITION, info_message, "validate thing", source_location)
