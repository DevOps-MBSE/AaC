...
class TestDefinedReferencesPlugin(ActiveContextTestCase):
    ...
    def test_validate_references_invalid_definition_reference(self):
        ...
        test_findings.add_error_finding(test_invalid_schema_definition, invalid_reference_error_message)
    ...
    def test_validate_references_invalid_primitive_reference(self):
        ...
        expected_findings.add_error_finding(test_invalid_schema_definition, invalid_reference_error_message)
