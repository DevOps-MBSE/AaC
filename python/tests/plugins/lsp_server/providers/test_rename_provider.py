...
class TestRenameProvider(BaseLspTestCase, IsolatedAsyncioTestCase):
    ...
    # TODO this one is just too hard...how on earth do you determine the parameters for rename here?
    ...
    # TODO the whole concept here is somewhat invalid when we remove root, do we need the test?
