...
# Alarm Clock
    ...
    Scenario:  Check the alarm clock model
        ...
        When I run the "check" command with arguments "./features/alarm_clock/alarm_clock.yaml" and no flags
    ...
    Scenario:  Check the alarm clock usecase
        ...
        When I run the "check" command with arguments "./features/alarm_clock/usecase.yaml" and flags "--verbose"
        Then I should receive a message that the command was successful
...
# Calculator
    ...
    Scenario:  Check the calculator spec
        ...
        When I run the "check" command with arguments "./features/calc/spec/Calculator_SystemSpec.yaml" and no flags
        Then I should receive a message that the command was successful

    Scenario:  Check the calculator model
        Given I have the "./features/calc/model/calculator.yaml" file
        When I run the "check" command with arguments "./features/calc/model/calculator.yaml" and flags "--verbose"
        Then I should receive a message that the command was successful
        And I should receive a list of successfully evaluated models
...
# Counter
    ...
    Scenario:  Check the counter model
        ...
        When I run the "check" command with arguments "./features/counter/Counter.yaml" and flags "--verbose"
        Then I should receive a message that the command was successful
        And I should receive a list of successfully evaluated models
...
# Docs examples
    ...
    Scenario:  Check the Definitions Example
        ...
        When I run the "check" command with arguments "./features/docs_examples/dev_guide_language_api_definitions/acceptance_test.aac" and no flags
        Then I should receive a message that the command was successful
    ...
    Scenario:  Check the First Inheritance Example
        ...
        When I run the "check" command with arguments "./features/docs_examples/dev_guide_language_api_modeling_inheritance/docs_inheritance_one.aac" and flags "--verbose"
        Then I should receive a message that the command was successful
        And I should receive a list of successfully evaluated models
    ...
    Scenario:  Check the Second Inheritance Example
        ...
        When I run the "check" command with arguments "./features/docs_examples/dev_guide_language_api_modeling_inheritance/docs_inheritance_two.aac" and no flags
        Then I should receive a message that the command was successful
    ...
    Scenario:  Check the All Possible Plugin Example
        ...
        When I run the "check" command with arguments "./features/docs_examples/dev_guide_plugin_dev_guide/docs_all_possible.aac" and no flags
        Then I should receive a message that the command was successful
    ...
    Scenario:  Check the Do Stuff Plugin Example
        ...
        When I run the "check" command with arguments "./features/docs_examples/dev_guide_plugin_dev_guide/docs_do_stuff.aac" and no flags
        Then I should receive a message that the command was successful
...
# Echo
    ...
    Scenario:  Check the echo model
        ...
        When I run the "check" command with arguments "./features/echo/EchoService.yaml" and flags "--verbose"
        Then I should receive a message that the command was successful
        And I should receive a list of successfully evaluated models
...
# Flow
    ...
    Scenario:  Check the flow system model
        ...
        When I run the "check" command with arguments "./features/flow/System.yaml" and no flags
        Then I should receive a message that the command was successful

    Scenario:  Check the flow usecase
        Given I have the "./features/flow/flow.yaml" file
        When I run the "check" command with arguments "./features/flow/flow.yaml" and flags "--verbose"
        Then I should receive a message that the command was successful
        And I should receive a list of successfully evaluated models
...
# Shapes
    ...
    Scenario:  Check the flow system model
        ...
        When I run the "check" command with arguments "./features/shapes/shapes.aac" and flags "--verbose"
        Then I should receive a message that the command was successful
        And I should receive a list of successfully evaluated models
