Feature:  If True Then Empty Evaluation
    ...
    Scenario:  Check the Schema Plugin File
        ...
        When I run the "check" command with arguments "./features/plugin_examples/schema_plugin.aac" and with no flags
    ...
    Scenario:  Check the Bad Schema Plugin File
        ...
        When I run the "check" command with arguments "./features/plugin_examples/schema_plugin_bad.aac" and with no flags
